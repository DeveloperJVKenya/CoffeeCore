...
class CoffeeViewInterventionsPage extends StatefulWidget {
  ...
  @override
  State<CoffeeViewInterventionsPage> createState() =>
      _CoffeeViewInterventionsPageState();
}

class _CoffeeViewInterventionsPageState
    extends State<CoffeeViewInterventionsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        appBar: AppBar(
          title: const Text('Saved Interventions',
              style:
      ...
      try {
        await widget.notificationsPlugin.zonedSchedule(
          ...
          androidScheduleMode: AndroidScheduleMode
              .exactAllowWhileIdle, // Ensures exact scheduling
        );
        if (mounted) {
          scaffoldMessenger.showSnackBar(
